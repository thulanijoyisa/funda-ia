...
import { HiOutlineChartBar, HiOutlineClock, HiOutlineBookOpen, HiOutlineVideoCamera, HiOutlineCheckCircle } from "react-icons/hi";
      ...
      <div className='mt-2'>
        {course?.courseOutput?.chapters.map((chapter, index) => {
          return ( // Add return here
            ...
            <div key={chapter.id || index} className='flex gap-5 items-center'> {/* Use a unique key for each chapter */}
